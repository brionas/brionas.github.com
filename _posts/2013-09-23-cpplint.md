...
![cpplint classes relationship](/assets/image/win1.jpg)
![cpplint classes relationship](/assets/image/win2.png)
选择Tool,按下图进行设置，Application 选择同步下来的cpplint.bat文件，点击OK，就可以在P4中使用cpplint.
![cpplint classes relationship](/assets/image/win3.jpg)
![cpplint classes relationship](/assets/image/win4.png)
在perforce中使用cpplint跟post-review一样，右键changelist, 点击cpplint,即可以看到cpplint的结果,如下：
![cpplint classes relationship](/assets/image/win5.png)
