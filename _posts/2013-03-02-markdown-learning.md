...
*注：ref中不区分大小写。*   
	...
	这是一个Inline[示例](http://liufeyu.cn "可选的title")。
	这是一个Reference[示例][ref]。
	[ref]: http://liufeiyu.cn

#### 效果：

这是一个*Inline*[示例](http://liufeiyu.cn "可选的title")。   
...
#### 语法：
	...
	Inline示例：![替代文本](http://life.liufeiyu.cn/images/avatar.jpg "可选的title")
	Reference示例：![替代文本][pic]
	[pic]: http://life.liufeiyu.cn/images/avatar.jpg "可选的title"
	HTML示例：<img src="http://life.liufeiyu.cn/images/avatar.jpg" alt="替代文本" title="标题文本" width="200" />

#### 效果：

<img src="http://equation85.github.com/assets/images/jian.jpg" alt="替代文本" title="标题文本" width="200" />
